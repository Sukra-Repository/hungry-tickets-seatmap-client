...
var _Legend = class _Legend extends Component {
  ...
  render() {
    ...
    const content = /* @__PURE__ */ jsxs("div", { style: this.containerStyle(), children: [
      /* @__PURE__ */ jsx("h3", { style: { margin: 0, marginBottom: 8, fontWeight: 700 }, children: "Map Legend" }),
      filteredTicketGroups.map((ticketGroup) => /* @__PURE__ */ jsxs("div", { style: this.itemStyle(), children: [
        /* @__PURE__ */ jsx(swatch_default, { color: ticketGroup.color }),
        /* @__PURE__ */ jsxs("div", { style: this.textContainerStyle(), children: [
          /* @__PURE__ */ jsx("strong", { children: ticketGroup.zone_name }),
          ticketGroup.description && ` - ${ticketGroup.description}`
        ] })
      ] }, ticketGroup.color))
    ] });
    return showLegendOpenAlwaysForDesktop && !isMobile ? /* @__PURE__ */ jsx("div", { style: { position: "relative" }, children: content }) : /* @__PURE__ */ jsxs("div", { style: { position: "relative" }, children: [
      /* @__PURE__ */ jsx(
        Button,
        {
